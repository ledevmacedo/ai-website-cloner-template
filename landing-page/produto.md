...
## Os módulos centrais do Impact Flow
...
## Portal de Talentos B2B

Um canal para empresas encontrarem talento validado.

Empresas parceiras podem consultar perfis de formandos com evidências reais de desempenho, reduzindo o risco de contratação.
...
[Entender como o fluxo funciona](como-funciona.md)
